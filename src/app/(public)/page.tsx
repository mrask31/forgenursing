  ...
  return <div className="text-[#0B2545]">
    ...
    <section className="mx-auto max-w-6xl px-5 py-14 sm:px-8 sm:py-20">
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-3">{[
        ...
        ['Help with the reasoning', 'Compare your selected answer with the explanation. Open the tutor from the question when you need a further walkthrough.'],
        ['Progress you can inspect', 'See how many questions you answered, what you missed, and whether recent practice accuracy changed. Small samples stay clearly labeled.'],
    ...
    <section className="border-y border-slate-200 bg-white"><div className="mx-auto grid max-w-6xl gap-8 px-5 py-12 sm:px-8 md:grid-cols-2"><div><h2 className="text-2xl font-bold">Keep the resources you trust.</h2><p className="mt-4 leading-relaxed text-slate-600">ForgeNursing is AI-assisted practice to use alongside your nursing references and prep resources. It does not guarantee a pass, diagnose why you failed, or replace a comprehensive NCLEX review.</p></div><div className="rounded-2xl bg-[#F0F7F8] p-6"><h3 className="font-bold">Try the full experience for {STANDARD_OFFER.trialDays} days.</h3><p className="mt-3 text-slate-600">Then ${STANDARD_OFFER.monthly}/month or ${STANDARD_OFFER.annual}/year. No credit card to start your trial. Subscribe when you choose.</p><Link href="/signup" className="mt-5 inline-flex min-h-11 items-center gap-2 font-bold text-[#087986]">Start your free trial <ArrowRight className="h-4 w-4" /></Link><p className="mt-3 text-xs text-slate-500">Existing founder and subscriber terms remain in place.</p></div></div></section>
